                    ...
                    <li class="submenu {{ request()->is('form*') ? 'active' : '' }}">
                        ...
                        <ul style="{{ request()->is('form*') ? 'display: block;' : '' }}">
                            ...
                            @can('view hr clearance form')
                                <li><a href="{{ route('hr.index') }}" class="{{ request()->routeIs('hr.index') ? 'active' : '' }}">HR Clearance and Exit Form</a></li>
                            @endcan
                            @can('view data security agreement')
                                <li><a href="{{ route('data.index') }}" class="{{ request()->routeIs('data.index') ? 'active' : '' }}">Data Security Agreement</a></li>
                            @endcan
                            @can('view change management')
                                <li><a href="{{ route('change.index') }}" class="{{ request()->routeIs('change.index') ? 'active' : '' }}">Change Management</a></li>
                            @endcan
                        </ul>
                    </li>
                @endcan
                    ...
                    <li class="submenu {{ request()->is('request*') ? 'active' : '' }}">
                        ...
                        <ul style="{{ request()->is('request*') ? 'display: block;' : '' }}">
                            ...
                            @can('approve requests')
                                <li><a href="{{ route('requestapprove.index') }}" class="{{ request()->routeIs('requestapprove.index') ? 'active' : '' }}">Requests Approval</a></li>
                            @endcan
                        </ul>
                    </li>
                @endcan
                ...
                @role('super-admin|admin|it')
                    <li class="submenu {{ request()->is('user-management*') ? 'active' : '' }}">
                        ...
                        <ul style="{{ request()->is('user-management*') ? 'display: block;' : '' }}">
                            @can('assign roles')
                                <li><a href="{{ route('users.index') }}" class="{{ request()->routeIs('users.index') ? 'active' : '' }}">Assign Roles</a></li>
                            @endcan
                            @can('manage roles')
                                <li><a href="{{ route('role.index') }}" class="{{ request()->routeIs('role.index') ? 'active' : '' }}">Manage Roles</a></li>
                            @endcan
                ...
                @can('view settings')
                    <li class="submenu {{ request()->is('settings*') ? 'active' : '' }}">
                        ...
                        <ul style="{{ request()->is('settings*') ? 'display: block;' : '' }}">
                            @can('view logs')
                                <li><a href="#" class="{{ request()->routeIs('logs.index') ? 'active' : '' }}">User Activity Logs</a></li>
                            @endcan
                        </ul>
                    </li>
                @endcan

...
<?php endif; ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php $__empty_1 = true; $__currentLoopData = $languageKnowledge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $knowledge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td><?php echo e($knowledge->language); ?></td>
                                                                <td><?php echo e($knowledge->speaking); ?></td>
                                                                <td><?php echo e($knowledge->reading); ?></td>
                                                                <td><?php echo e($knowledge->writing); ?></td>
                                                                <td>
                                                                    <!-- Edit and Delete Icons -->
                                                                    <a href="#" class="text-primary edit-btn"
                                                                        data-id="<?php echo e($knowledge->id); ?>"
                                                                        data-language="<?php echo e($knowledge->language); ?>"
                                                                        data-speaking="<?php echo e($knowledge->speaking); ?>"
                                                                        data-reading="<?php echo e($knowledge->reading); ?>"
                                                                        data-writing="<?php echo e($knowledge->writing); ?>"
                                                                        title="Edit">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <form
                                                                        action="<?php echo e(route('language_knowledge.destroy', $knowledge->id)); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addLanguageBtn').addEventListener('click', function() {
                ...
                document.getElementById('languageForm').action = '<?php echo e(route('language_knowledge.add')); ?>';
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\E-docs\resources\views/language/index.blade.php ENDPATH**/ ?>
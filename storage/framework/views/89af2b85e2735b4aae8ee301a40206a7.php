            ...
            <ul>
                ...
                <li class="submenu <?php echo e(request()->is('form*') ? 'active' : ''); ?>">
                    ...
                    <ul style="<?php echo e(request()->is('form*') ? 'display: block;' : ''); ?>">
                        ...
                        <li><a href="<?php echo e(route('data.index')); ?>"
                                class="<?php echo e(request()->routeIs('data.index') ? 'active' : ''); ?>">Data Security Form
                            </a></li>
                        <li><a href="<?php echo e(route('change.index')); ?>"
                                class="<?php echo e(request()->routeIs('change.index') ? 'active' : ''); ?>">Change Request
                                Form</a>
                        </li>
...
<?php /**PATH C:\Users\FAMILY PC\Documents\GitHub\E-docs\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>
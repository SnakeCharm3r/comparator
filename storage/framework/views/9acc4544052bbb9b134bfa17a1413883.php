                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="business_owner" id="business_owner"
                                        class="form-control <?php $__errorArgs = ['business_owner'];
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('business_owner', $vendor->business_owner)); ?>" required>
                                    <?php $__errorArgs = ['business_owner'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('contact_person', $vendor->contact_person)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('telephone_number', $vendor->telephone_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('email_address', $vendor->email_address)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="physical_address" id="physical_address"
                                        class="form-control <?php $__errorArgs = ['physical_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('physical_address', $vendor->physical_address)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                                    <?php if($vendor->contract_file): ?>
                                        <a href="<?php echo e(Storage::url($vendor->contract_file)); ?>" class="btn btn-info mt-2"
...
unset($__errorArgs, $__bag); ?>"
                                        step="0.01" value="<?php echo e(old('contract_total_value', $vendor->contract_total_value)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('duration_years', $vendor->duration_years)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="likelihood_rating" id="likelihood_rating"
                                        class="form-control <?php if($vendor->likelihood_rating <= 3): ?> table-success <?php elseif($vendor->likelihood_rating <= 6): ?> table-warning <?php else: ?> table-danger <?php endif; ?> <?php $__errorArgs = ['likelihood_rating'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('likelihood_rating', $vendor->likelihood_rating)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="impact_rating" id="impact_rating"
                                        class="form-control <?php if($vendor->impact_rating <= 3): ?> table-success <?php elseif($vendor->impact_rating <= 6): ?> table-warning <?php else: ?> table-danger <?php endif; ?> <?php $__errorArgs = ['impact_rating'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('impact_rating', $vendor->impact_rating)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="overall_risk_score" id="overall_risk_score"
                                        class="form-control <?php if($vendor->overall_risk_score <= 3): ?> table-success <?php elseif($vendor->overall_risk_score <= 6): ?> table-warning <?php else: ?> table-danger <?php endif; ?> <?php $__errorArgs = ['overall_risk_score'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('overall_risk_score', $vendor->overall_risk_score)); ?>">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\E-docs\resources\views/vendors/edit.blade.php ENDPATH**/ ?>